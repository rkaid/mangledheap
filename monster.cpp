...
void Monster::setai(int which)
{
    which_ai = which;
}

void Monster::random_ai()
{
    int choice = ri(1,9);
    switch (choice) {
        case 1:
...
void Monster::set_random_goal()
{
}

void Monster::set_in_combat()
{
    in_combat = true;
    has_goal = true;
}

void Monster::use_stairs()
{
...
/*
 * This is actually the standard AI, at least for Monster characters
 */
void Monster::path_ai()
{
